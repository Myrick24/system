...
class TransactionService {
        ...
        if (data['createdAt'] != null) {
          ...
          if (data['createdAt'] is String) {
            try {
              ...
              print(
                  'Error parsing transaction date string: ${data['createdAt']}');
              continue;
            }
  ...
  // Process payment for an order and send notifications
  Future<bool> processPayment({
    ...
    try {
      ...
      await NotificationManager.sendPaymentNotification(
        ...
        orderId: orderId,
        amount: amount,
        isReceived: false, // Buyer sent payment
      );
      ...
      await NotificationManager.sendPaymentNotification(
        ...
        orderId: orderId,
        amount: amount,
        isReceived: true, // Seller received payment
      );
